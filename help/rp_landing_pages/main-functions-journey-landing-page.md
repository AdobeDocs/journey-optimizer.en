...
Explore an overview of the main functions available, categorized by type and purpose, to build expressions in journeys.

[Learn more about main functions](../using/building-journeys/expression/functions.md)
:::
