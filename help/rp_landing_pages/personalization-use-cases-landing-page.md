...
Learn how to create personalized push notifications for order status updates using profile, contextual, and offer decisioning data.

[Start the tutorial](../using/personalization/personalization-use-case.md)
:::
...
Discover how to personalize cart abandonment emails using helper functions to add customer-specific and product-specific details.

[Explore the guide](../using/personalization/personalization-use-case-helper-functions.md)
:::
...
Create personalized emails for health plan subscribers to highlight prescription statuses such as ready for pick up or recalled.

[View the example](../using/personalization/perso-uc-plan-prescriptions.md)
:::
