...
Learn the fundamentals of campaigns in Adobe Journey Optimizer, including types, permissions, and prerequisites.
...
Discover how to access, manage, modify, or archive campaigns, and explore the campaign calendar view.

[Learn how to manage campaigns](../using/campaigns/modify-stop-campaign.md)
:::
...
[Explore Action campaigns](action-campaigns-landing-page.md)
:::
...
Comprehensive guidance for developers on creating and managing real-time API-triggered campaigns.

[Learn about API-triggered campaigns](api-triggered-campaigns-landing-page.md)
:::
...
[Dive into orchestrated campaigns](orchestrated-campaigns-landing-page.md)
:::
