...
[Get started with the guide](../using/orchestrated/gs-campaign-creation.md)
:::
...
[Learn how to create and schedule](../using/orchestrated/create-orchestrated-campaign.md)
:::
...
Master the visual canvas to design and configure activities for your Orchestrated campaigns.

[Explore activity orchestration](../using/orchestrated/orchestrate-activities.md)
:::
...
Learn how to test, publish, and monitor your Orchestrated campaigns for successful execution.

[Start and monitor your campaigns](../using/orchestrated/start-monitor-campaigns.md)
:::
...
[Dive into reporting](../using/orchestrated/reporting-campaigns.md)
:::
