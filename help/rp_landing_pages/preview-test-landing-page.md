...
[Learn how to select test profiles](../using/content-management/test-profiles.md)
:::
...
Step-by-step guide to previewing personalized content using test profiles and simulating content variations.

[Preview content with test profiles](../using/content-management/preview.md)
:::
...
Test and validate your email messages by sending proofs using test profile data to ensure content accuracy.

[Learn how to send proofs](../using/content-management/proofs.md)
:::
...
[Test email rendering with Litmus](../using/content-management/rendering.md)
:::
