...
Understand the components, workflows, and data flow required to deliver push notifications using Adobe Journey Optimizer.

[Learn about Push Notification Flow](../using/push/push-gs.md)
:::
...
Step-by-step guidance for setting up permissions, integrating apps, and configuring the push notification channel.
...
Quickly configure mobile event data collection and enable push notifications with an automated workflow.

[Start Mobile Onboarding Workflow](../using/push/mobile-onboarding-wf.md)
:::
