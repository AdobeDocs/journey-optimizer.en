...
You can attach up to five personalized PDF files to an email, with a different file for each recipient. [Learn how to attach personalized PDF files](../email/pdf-attachments.md#personalized-attachments)
