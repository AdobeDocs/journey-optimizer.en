...
### EXTERNAL_KEY_COMPUTATION_ERROR

||Description|
|---|---|
|**Definition**|The system could not compute a unique identifier (external key) for the customer from the event data.|
...
### NO_INTERESTED_JOURNEYS_FOR_SEGMENTMEMBERSHIP_EVENT

||Description|
|---|---|
|**Definition**|A segment qualification event was received, but no journeys are configured to respond to this segment.|
...
### JOURNEY_INSTANCE_ID_NOT_CREATE

||Description|
|---|---|
|**Definition**|The system failed to create a journey instance for the customer.|
...
### EVENT_WITH_NO_JOURNEY

||Description|
|---|---|
|**Definition**|An event was received but no active journey is configured to respond to it.|
