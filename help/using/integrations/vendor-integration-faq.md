...
➡️ [Learn more on the Integrations overview](integrations.md)
...
➡️ [Learn more on administrator and marketer workflows](integrations.md)
...
➡️ [Learn more on creating an integration](integrations.md#configure)
...
➡️ [Learn more on example data from third party systems](integrations.md)
...
➡️ [Learn more on integration configuration](integrations.md#configure)
...
➡️ [Learn more on authentication types](integrations.md#configure)
...
➡️ [Learn more on response payload mapping](integrations.md#configure)
...
➡️ [Learn more on personalization with Integrations](integrations.md#personalization)
...
➡️ [Learn more on journeys and campaigns](integrations.md#limitations)
...
➡️ [Learn more on supported channels](integrations.md#limitations)
...
➡️ [Learn more on retrieval versus listing APIs](integrations.md#limitations)
...
➡️ [Learn more on what Integrations are for](integrations.md)
...
➡️ [Learn more on test connection and payload validation](integrations.md#configure)
...
➡️ [Learn more on test connection and activation](integrations.md#configure)
