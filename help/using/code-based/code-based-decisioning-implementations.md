...
➡️ Learn more about configuring the Web SDK for code-based experiences and decisioning in [these tutorials](#tutorials).

## Testing code-based experiences using decisions {#code-based-test-decisions}

You can preview decision items from the user interface when building a [code-based experience](create-code-based.md) campaign or journey: use **[!UICONTROL Simulate content]** and select test profiles to see which decision items qualify. [Learn more](test-code-based.md#preview-code-based).
