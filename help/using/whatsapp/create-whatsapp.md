...
1. From the **WhatsApp template** drop-down, select your previously created template designed in Meta. 
    ...
    >[!NOTE]
    >
    >You can select a **WhatsApp Flow** template to deliver interactive multi-screen experiences, such as surveys or lead capture forms, directly within the WhatsApp conversation. All inbound WhatsApp responses, including those submitted through WhatsApp Flow templates, are captured in the _AJO Channel Tracking Event Dataset_. [Learn more about system datasets](../data/get-started-datasets.md#system-datasets).
