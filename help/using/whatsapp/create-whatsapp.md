...
1. From the **WhatsApp template** drop-down, select your previously created template designed in Meta. 
    ...
    >[!NOTE]
    >
    >You can select a **WhatsApp Flow** template to deliver interactive multi-screen experiences, such as surveys or lead capture forms, directly within the WhatsApp conversation. Responses are captured upon submission and stored as raw JSON payloads in the _AJO Channel Tracking Event Dataset_. [Learn more about system datasets](../data/get-started-datasets.md#system-datasets).
