...
| Decision management |<ul> <li>**[!DNL Manage decisions]**: read, create, edit, and delete decisions.</li> <li>**[!DNL Manage ranking strategies]**: read, create, edit, and delete ranking strategies.</li> </ul> |
| Journeys |<ul> <li>**[!DNL Manage journeys]**: read, create, edit, pause, stop, and delete journeys.</li> <li>**[!DNL Manage journeys events, data sources and actions]**: read, create, edit, and delete events, sources or actions.</li> <li>**[!DNL Publish journeys]**: publish journeys.</li> <li>**[!DNL View journeys report]**: read and edit journeys report.</li> </ul> |
