...
>[!NOTE]
>
>When ingesting data, emails are case-sensitive, meaning that duplicate profiles can be created (for example, one profile for John.Greene@luma.com, another profile for john.green@luma.com) and used when targeting these profiles in your [!DNL Journey Optimizer] journeys and campaigns.
