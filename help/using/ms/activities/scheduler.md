...
description: Learn how to use the Scheduler activity in an orchestrated campaign
hide: yes
hidefromtoc: yes
...
>abstract="The **Scheduler** activity allows you to schedule when the orchestrated campaign gets started. This activity should be considered as a scheduled start. It can only be used as the first activity of the orchestrated campaign."


The **Scheduler** activity is a **Flow control** activity. It allows you to schedule when the orchestrated campaign gets started. This activity should be considered as a scheduled start. It can only be used as the first activity of the orchestrated campaign. 
...
* If you want to send a one-shot delivery in your orchestrated campaign, you can add a scheduler activity and set it to run **Once**. You can also define the **Schedule** in the delivery's settings.
* If you want to send a recurring delivery in your orchestrated campaign, you need to use a **Scheduler** activity and set the execution frequency. The recurring delivery activity does not allow you to define a schedule.
...
1. Add a **Scheduler** activity to your orchestrated campaign.
...
In the following example, the activity is configured so that the orchestrated campaign runs several times a day at 9 and 12 AM, every day of the week from October 1st, 2025 to January 1st, 2026.
