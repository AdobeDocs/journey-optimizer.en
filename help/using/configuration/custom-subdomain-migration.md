...
* [Copy the SSL CDN URL validation record](#copy-ssl-cdn-url-record) generated by Adobe into your hosting platform
...
1. One you retrieved your SSL certificate, click **[!UICONTROL Upload certificate]**.
...
To complete the migration process, copy the SSL CDN URL validation record generated by Adobe into your hosting platform. The process is the same as when setting up a new custom subdomain. Follow the steps detailed on the [Set up a custom subdomain](delegate-custom-subdomain.md#copy-ssl-cdn-url-record) page.
