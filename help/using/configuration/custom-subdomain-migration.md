...
1. You can use the **[!UICONTROL Pre-migration CSR Generation]** section to generate the CSR for sending it to the Certificate Authority and have the SSL certificate ready when the migration process starts. [Learn how](#send-csr-to-ca)
    ...
    ![Pre-migration CSR Generation section in the subdomain settings](assets/subdomain-migrate-pre-migration-csr.png){width="70%"}
...
1. Fill the form that displays and regenerate the Certificate Signing Request (CSR).
    ...
    ![Form to regenerate the Certificate Signing Request](assets/subdomain-migrate-regenerate-csr.png){width="60%"}
...
1. Make sure that all the DNS records have been deleted. Once done, check the box "I confirm that I have deleted the required records from hosting site".
    ...
    ![Confirmation checkbox for deleting existing DNS records](assets/subdomain-migrate-delete-dns.png){width="75%"}
...
1. Once you have retrieved your SSL certificate, click **[!UICONTROL Upload certificate]**.
    ...
    ![Upload certificate button in the SSL Certificate section](assets/subdomain-migrate-ssl-certificate.png){width="75%"}
...
![Feedback loop steps for domain ownership verification](assets/subdomain-migrate-feedback-loop.png){width="75%"}
...
1. If all validations are successful, the **[!UICONTROL Records to be created]** section displays.
    ...
    ![List of DNS records to be created in the hosting platform](assets/subdomain-migrate-records-to-create.png){width="75%"}
