...
title: Use Journey Optimizer APIs
description: Journey Optimizer provide RESTful APIs that allow you to programmatically perform key operations in your applications. Learn how to access and use them.
...
Follow [this tutorial](https://developer.adobe.com/journey-optimizer-apis/references/authentication/){target="_blank"} to gather the required authentication credentials for all Journey Optimizer APIs.

Learn more in [Adobe Journey Optimizer API documentation](https://developer.adobe.com/journey-optimizer-apis/){target="_blank"}. Browse the **API references** menu to access all Journey Optimizer APIs and try them.

APIs are also available for Decision management in Adobe Journey Optimizer. Learn more in [Decision Management API developer guide](../offers/api-reference/getting-started.md)