...
>[!AVAILABILITY]
>
>Currently, Web push notifications in Journey Optimizer do not support the **Silent Notification** and **Simulate Content** features, but will be available at a later time.
