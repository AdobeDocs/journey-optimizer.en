...
* Business events have an additional, stricter guardrail: the payload of a single business event is limited to a maximum of **64 KB**. Events exceeding this size are dropped and do not trigger the journey. This is separate from the 1 MB journey instance limit above. [Learn more about configuring business events](../event/about-creating-business.md).
