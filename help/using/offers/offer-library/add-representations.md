...
>
>When you use the personalization editor in Decision management, only a subset of functions is supported—see [Supported functions in the expression editor](../personalization-editor-supported-functions.md).
...
You can personalize URLs using the personalization editor. Learn more about [personalization](../../personalization/personalize.md#use-expression-editor). In Decision management, only certain functions are supported—see [Supported functions in the expression editor](../personalization-editor-supported-functions.md).
...
1. Type the text that will display in the offer.
    ...
    You can personalize your content using the personalization editor. Learn more about [personalization](../../personalization/personalize.md#use-expression-editor). In Decision management, only certain functions are supported—see [Supported functions in the expression editor](../personalization-editor-supported-functions.md).
