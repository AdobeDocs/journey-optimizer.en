...
You can also insert an Adobe Experience Manager Content Fragment directly into your offer by clicking **[!UICONTROL Content Fragment]**. Note that to access Content Fragment in Offers, the selected placement must be of type JSON. 
Learn more about [Content fragment integration with Journey Optimizer](../../integrations/aem-fragments.md).
