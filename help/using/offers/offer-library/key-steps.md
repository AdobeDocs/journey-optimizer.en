...
1. [Create offers](creating-personalized-offers.md), and configure their content and properties. When you personalize offer content (representations), only certain expression functions are supported—see [Supported functions in the expression editor](../personalization-editor-supported-functions.md).
