...
Now that your decision is live, you can insert it into an email message. To do so, follow the steps detailed on [this page](../../using/email/add-offers-email.md).
