...
description: Learn how to use ready-to-use modules to build emails faster in Adobe Journey Optimizer.
feature: Email Design
topic: Content Management
role: User
level: Beginner, Intermediate
keywords: modules, email designer, headers, hero, cards, footer, email layout, drag and drop
---

# Use modules in the Email Designer {#email-layout-modules}

>[!BEGINSHADEBOX]

**On this page:** Learn how to use ready-to-use modules — such as headers, hero sections, product cards, and footers — to speed up email creation in the Email Designer without building structures from scratch.
...
>id="ac_email_modules"
>title="About modules"
>abstract="Modules are predefined, reusable email layout blocks that you can drag and drop directly into your email canvas. Each module comes pre-configured with a curated set of editable properties — such as images, text, buttons, and links — that you can customize through the WYSIWYG interface."
...
Unlike [content components](content-components.md), which are empty placeholders that you configure from scratch, modules are pre-built sections — such as a branded header, a product card grid, or a footer with opt-out links — that you drop directly onto your canvas and customize from there.
