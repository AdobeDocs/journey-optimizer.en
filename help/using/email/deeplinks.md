...
For SMS, deeplinks are authored using the **Url** helper function in the personalization editor. Learn more on adding links to SMS content in [this section](../mobile/design-mobile.md#sms-content).
