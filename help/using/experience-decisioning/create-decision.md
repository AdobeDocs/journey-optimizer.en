...
* **Supported channels** - Decision policies are available to all customers for Code-based Experience, SMS, and Push notifications. Decisioning for the Email channel is available in Limited Availability only.
