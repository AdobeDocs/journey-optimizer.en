...
Experience Decisioning is available today via the Code-based experience channel. 

Code-based experiences support any type of customer implementation:
...
➡️ [Learn more about code-based implementation methods](../../code-based/code-based-implementation-samples.md)
