...
* When creating [content optimization targeting](../campaigns/optimization-targeting.md) in journeys or campaigns;
...
1. Select the rule entity to specify which type of object the rule is being created for.
    ...
    * **[!UICONTROL Targeting]** - The rule can be used when building [targeting](#targeting-rules) rules, either as part of [content optimization](../campaigns/optimization-targeting.md) in a campaign or a journey, either in the [Optimize journey activity](../building-journeys/optimize.md#targeting).
