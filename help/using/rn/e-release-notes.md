...
<tr>
<td>
<p>Loyalty Challenges turn loyalty initiatives into engaging, gamified experiences that motivate customers to take valuable actions, such as making purchases, writing reviews, engaging on social media, or referring friends.</p>
...
Journey Optimizer introduces the Onboarding Hub, a new capability in this release.

<table>
<thead>
<tr>
<th><strong>Onboarding Hub</strong><br/></th>
</tr>
</thead>
<tbody>
<tr>
<td>
<p>Transitioning to Adobe Journey Optimizer from another marketing platform is now faster and simpler. The new onboarding hub features a migration workspace that lets you import your existing email content and journeys automatically, saving you from having to rebuild them from scratch.</p>
...
* **Target dimension simplification in Orchestrated campaigns** - The active targeting dimension is now shown on the workflow canvas, so you can see which dimension is used by a channel activity. The multi-entity segmentation flow is simpler as you no longer need a separate "Change dimension" activity. Moreover, you can now choose explicitly whether messages are sent at the profile level or at a secondary dimension level. ([DOCAC-13554](https://jira.corp.adobe.com/browse/DOCAC-13554)) <!-- Documentation link: TBD -->
...
* **Decisioning rules and ranking formulas creation from natural language expression** - You can now describe the Decisioning rule or ranking formula you want to create in plain language and let the AI Assistant generate it for you. This capability is available to customers with access to Adobe AI capabilities. ([DOCAC-15231](https://jira.corp.adobe.com/browse/DOCAC-15231)) <!-- Documentation link: TBD -->
