...
![Approval request dialog](assets/approval-request.png)
...
![Cancel approval request button](assets/approval-cancel.png)

## Manage approval requests 

Once the approval request has been sent to the approvers, they can review it and either activate the journey/campaign to make it live or request changes if necessary. [Learn how to review & approve a request](review-approve-request.md)
