...
1. Under **[!UICONTROL Processed data]**, choose your **[!UICONTROL Path to the date field]**. The attribute must use the **Date Time** format. Each run returns only rows whose date is after the last execution.
