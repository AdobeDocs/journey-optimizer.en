...
title: Define global variables in Orchestrated campaigns
description: Learn how to add and manage global variables on an Orchestrated campaign.
feature: Campaigns
...
1. Click the **...** icon next to **[!UICONTROL Save]**, then select **[!UICONTROL Edit variables]**.
   ...
   ![Edit variables option in the campaign menu](assets/variables-list.png){zoomable="yes"}
...
1. Click **[!UICONTROL Add variable]** and set the variable’s name and value. To edit an existing variable, click the **...** button and select **[!UICONTROL Edit]**.
   ...
   ![Variables panel to add or edit variables](assets/variables-edit.png){zoomable="yes"}
