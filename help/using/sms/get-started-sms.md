...
Adobe Journey Optimizer sends text messages through SMS service providers (or SMS gateway providers). Before creating your SMS/MMS/RCS message, configure your service provider for text and RCS messaging with Journey Optimizer. [Learn more](sms-configuration.md)
...
<div>
<a href="sms-configuration.md"><strong>Configure SMS/MMS/RCS</strong></a>
</div>
<p>
</td>
</tr></table>
