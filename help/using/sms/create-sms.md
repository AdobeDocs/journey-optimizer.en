...
1. To add a deeplink that opens a specific screen in your mobile app, use the URL helper with the `DEEPLINK` type. [Learn more about deeplinks](../email/deeplinks.md)
