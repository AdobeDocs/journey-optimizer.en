...
* **[!UICONTROL Target attributes]** : This folder is specific to Orchestrated campaigns. It contains attributes calculated directly within the campaign canvas. [Learn how to use enrichment collection data in personalization](../orchestrated/activities/enrichment.md#collection-personalization)
