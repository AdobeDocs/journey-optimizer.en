...
* **[Target attributes](../orchestrated/add-personalization.md)** (Orchestrated campaigns only): Attributes calculated on the campaign canvas, including enrichment collection arrays
