...
>[!NOTE]
>
>One-shot Read audience journeys move to the Finished status 90 days after the journey execution. For scheduled Read audiences, it is 90 days after the execution of the last occurrence.
