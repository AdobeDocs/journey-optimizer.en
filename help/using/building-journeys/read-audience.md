...
>[!NOTE]
>
>One-shot Read audience journeys move to the **Finished** status 91 days ([default timeout](journey-gs.md#global_timeout)) after the journey execution. For scheduled Read audiences, it is 91 days after the execution of the last occurrence.
