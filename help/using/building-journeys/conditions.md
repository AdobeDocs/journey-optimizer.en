...
1. On the left side, unfold **[!UICONTROL Audiences]** node. Drag and drop the audience you want to use for your condition. By default, the condition on the audience is true.
   ...
   >
   >For audience validation guardrails, including the 5,000-audience cache limitation and the workaround, see the [inAudience function](functions/functioninaudience.md#guardrails).
