...
title: Troubleshoot your journey
description: Learn how to troubleshoot your journey
feature: Journeys
...
<table style="table-layout:fixed">
  <tr style="border: 0;">
    ...
    <div><strong>Troubleshoot journey errors</strong><br/> Learn how to identify and resolve activity or journey errors before test or publication, and how to define a fallback action in case of an error in journey activities.</div>
    </td>
    <td>
...
<tr style="border: 0;">
  <td>
    ...
    <img alt="Understand common error codes" src="../assets/do-not-localize/icon-quick-start.svg" /></a> 
    <br>Additionally, check out this Adobe Community blog post detailing <strong>common error codes</strong> and how to resolve them effectively.
    </div>
      <div>
     <a href="https://experienceleaguecommunities.adobe.com/t5/journey-optimizer-blogs/demystifying-adobe-journey-optimizer-error-codes-root-causes-and/ba-p/760884" target="_blank">Learn more</a></div>
    </div>
  </td>
</tr>
</table>
