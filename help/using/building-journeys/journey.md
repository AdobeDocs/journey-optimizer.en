...
[Choose how to test and validate your journey →](choose-validation-method.md) | [Test your journey →](testing-the-journey.md) | [Learn about dry run →](journey-dry-run.md)
