...
+ Multi-step campaigns {#ms-campaigns}
  ...
  + Work with multi-step campaign activities {#design-campaigns}
    ...
    + [Change data source](using/ms/activities/change-data-source.md)
    ...
    + [Email, SMS, Push, Direct mail](using/ms/activities/channels.md)
    + [Enrichment](using/ms/activities/enrichment.md)
    + [External signal](using/ms/activities/external-signal.md)
    + [Extract file](using/ms/activities/extract-file.md)
    + [Fork](using/ms/activities/fork.md)
    + [Incremental query](using/ms/activities/incremental-query.md)
    + [JavaScript code](using/ms/activities/javascript-code.md)
    ...
    + [Subscription services](using/ms/activities/subscription-services.md)
    + [Test](using/ms/activities/test.md)
    + [Transfer file](using/ms/activities/transfer-file.md)
